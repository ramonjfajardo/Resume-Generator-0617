...
Do not return markdown fences, explanations, or any text outside the JSON object.

Candidate: {{name}} | {{email}} | {{location}}
Experience: {{yearsOfExperience}} years
Roles: {{experienceCount}}
...
Output schema:
{"title":"...","summary":"...","skills":{"Category":["Skill1",...],...},"experience":[{"title":"...","details":["...",...]}]}
...
5. Use exactly one specialization phrase only when the core role does not match. Choose one from: Frontend Specialist, Backend Architect, Full Stack Experience, DevOps Specialist, AI Engineer, Quality Assurance Specialist, Infrastructure Specialist.
6. Use 3–4 most important technologies/tools/platforms from the JD in the title. Separate segments with " | ".
...
- Write 5–6 sentences, 140–175 words, plain text only.
- Sentence 1: [Most Recent Title] with {{yearsOfExperience}}+ years in [domain].
- Sentence 2: Expertise in [primary domain keyword] plus 3–4 JD technologies.
...
- Group cloud entries when appropriate, e.g. "AWS (Lambda, S3, EC2)".
- Do not include version spam.
...
- Only mention tools/frameworks that existed during the job period.
- For older jobs, use older alternatives if needed (e.g. jQuery, Backbone.js, AngularJS 1.x, PHP, Java, .NET, Ruby on Rails).
...
- Do not include any additional commentary, markdown, or explanation.
